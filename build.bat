...
set EXEC=msbuild
:: IS /I specified?
echo %ARGS% | FIND /I "/I" >NUL
IF NOT ERRORLEVEL 1 (
  set EXEC=buildconsole 
)

set EXEC=msbuild


set BUILD_BUILDTYPE=Win32
:: IS /WIN64 specified?
echo %ARGS% | FIND /I "/WIN64" >NUL
IF NOT ERRORLEVEL 1 set BUILD_BUILDTYPE=x64

echo %ARGS% | FIND /I "/x64" >NUL
IF NOT ERRORLEVEL 1 set BUILD_BUILDTYPE=x64

echo %ARGS% | FIND /I "/x86" >NUL
IF NOT ERRORLEVEL 1 set BUILD_BUILDTYPE=x86
