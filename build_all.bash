...
cmake  ${CURR_PATH}/dependencies/assimp-3.3.1 -DCMAKE_CXX_FLAGS=-DASSIMP_BUILD_NO_XFILE_EXPORTER=1 -DASSIMP_BUILD_ASSIMP_TOOLS=off -DASSIMP_BUILD_TESTS=OFF -DASSIMP_BUILD_X_IMPORTER=off -DCMAKE_INSTALL_PREFIX=${CURR_PATH}/installed && make -j2 && make install && popd
...
#soil
mkdir -p  ${CURR_PATH}/build/soil && pushd ${CURR_PATH}/build/soil
cmake  ${CURR_PATH}/dependencies/SOIL   -DCMAKE_INSTALL_PREFIX=${CURR_PATH}/installed && make -j2 && make install && popd
